...
public class DoorTest extends TestMap {
	...
	public static void main(String[] args) throws Exception {
		...
		ClientApplication app = new ClientApplication( new TFile( test.resources.dropbox.dropboxFolderPath + "/script/map templates/doorTest.lua" ), test.resources, test.settings, false );
		app.init();
